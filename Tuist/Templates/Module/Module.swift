...
let template = Template(
    ...
    items: [
        .file(
            path: "Poscrisma/Modules/\(nameAttribute)/\(nameAttribute).swift",
            templatePath: "Files/Sources/Feature.stencil"
        ),
        .file(
            path: "Poscrisma/Modules/\(nameAttribute)/\(nameAttribute)Controller.swift",
            templatePath: "Files/Sources/Controller.stencil"
        ),
        .file(
            path: "Poscrisma/Modules/\(nameAttribute)/\(nameAttribute)View.swift",
            templatePath: "Files/Sources/View.stencil"
        ),
        .file(
            path: "Poscrisma/Modules/\(nameAttribute)/\(nameAttribute)Model.swift",
